...
}, "C:/Users/marco_0nue3ys/Documents/Cursos/MiduDev/Astro/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const SPAIN = "ES";
  const country = Astro2.request.headers.get("X-Vercel-IP-Counrtry") ?? "ES";
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} title="Comprar Libro" target="_blank" rel="noopner noreferrer" class="text-balance inline-flex gap-2 items-center bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 text-black font-bold py-2 px-4 rounded-lg border border-yellow-500 transition duration-200 ease-in-out hover:scale-105 justify-center text-center">
Comprar en Amazon ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "C:/Users/marco_0nue3ys/Documents/Cursos/MiduDev/Astro/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/marco_0nue3ys/Documents/Cursos/MiduDev/Astro/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
